...
public class ManagementCompanyTest {
	...
	public void testAddProperty() {
		...
		assertEquals(m.addProperty(p6), -1, 0); // exceeds the size of the array and can not be added, add property
												// should return -1
	}
	...
	/*
	 * @Test public void testDisplayPropertyAtIndex() { //find and print the third
	 * property String prop = m.displayPropertyAtIndex(2); //split the toString into
	 * an array String[] propArray = prop.split(" "); //test that the last element
	 * of the toString is the rent of the third property
